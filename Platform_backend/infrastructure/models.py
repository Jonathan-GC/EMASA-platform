...
class Activation(models.Model):
    ...
    app_s_key = models.CharField(max_length=32, help_text="Application session key (Chirpstack)") # cs
    dev_addr = models.CharField(max_length=8, help_text="Device address (Chirpstack)") # cs 
    f_cnt_up = models.IntegerField()    
    f_nwk_s_int_key = models.CharField(max_length=32, help_text="Network session key (Chirpstack)") # cs
    n_f_cnt_down = models.IntegerField()
    nwk_s_enc_key = models.CharField(max_length=32, help_text="Network session key (Chirpstack)") # cs
...
class Device(models.Model):
    ...
    workspace = models.ForeignKey(Workspace, on_delete=models.CASCADE) # cs Workspace.Tenant
    ...
    activation = models.ForeignKey(Activation, on_delete=models.CASCADE, null=True, blank=True)
