...
from .serializers import DeviceProfileSerializer, DeviceProfileTemplateSerializer, ApiUserSerializer, TenantUserSerializer
...
class TenantUserViewSet(viewsets.ModelViewSet, PermissionKeyMixin):
    ...
    def perform_create(self, serializer):
        instance = serializer.save()
        self.create_permission_keys(instance, scope="tenant_user")
